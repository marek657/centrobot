<div class="container">
  <div class="panel panel-default">
    <div class="panel-heading">
        <h3 class="panel-title"><?php echo ($this->lang->line("add_domain")); ?></h3>
    </div>
    <div class="panel-body">
    	<?php 
	    	echo ("<h3>" . $this->lang->line("add_names") . "</h3>");
	    	echo form_open('robtivityController/addDomain'); 
    	...
    	<select name="id_parrent" class="form-control">
    		...
    		?>
    			<option value="<?php echo $value->id_domain; ?>" ><?php echo $value->domain_name; ?></option>
    		<?php }	?>
		</select>
    	<br />

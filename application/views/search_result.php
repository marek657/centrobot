<div class="container">
	...
	<div class="panel panel-default"><!-- /search result -->
		<div class="panel-heading">
			<h3 class="panel-title"><?php echo ($this->lang->line("nav_search_result")); ?></h3>
		</div>
		<div class="panel-body">
			...
			<?php foreach ($results as $key => $value) { ?>
				<div class="panel panel-default">
					<div class="panel-heading">
						<h3 class="panel-title"> <a href="<?php echo base_url(); ?>index.php/robtivityController/viewrobtivity/<?php echo ($value->id_robtivity); ?>/1"><?php echo ($value->name); ?></a></h3>
					</div>
					<div class="panel-body">

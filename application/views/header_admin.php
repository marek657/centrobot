		      ...
		      <ul class="nav navbar-nav navbar-right">
		        <li class="dropdown">
		          ...
		          <ul class="dropdown-menu">
   		            <li><a href="<?php echo base_url(); ?>index.php/adminController/getRobtivies"><?php echo ($this->lang->line("nav_robtivies")); ?></a></li> 
		            ...
		            <li><a href="<?php echo base_url(); ?>index.php/adminController/getNotApprovedUsers"><?php echo ($this->lang->line("nav_registrations")); ?></a></li> 
   		            <li><a href="<?php echo base_url(); ?>index.php/adminController/getUsers"><?php echo ($this->lang->line("nav_users")); ?></a></li> 

		            <li><a href="<?php echo base_url(); ?>index.php/adminController/getDomains"><?php echo ($this->lang->line("nav_domain")); ?></a></li> 
		            <li><a href="<?php echo base_url(); ?>index.php/adminController/getLevels"><?php echo ($this->lang->line("nav_level")); ?></a></li> 
		            <li><a href="<?php echo base_url(); ?>index.php/adminController/getTechnologys"><?php echo ($this->lang->line("nav_technology")); ?></a></li> 
		            <li class="divider"></li>
